...
export default function ClassCard({ classObj }: { classObj: Class }) {
  return (
    <div
      className="w-full mt-10 h-auto bg-card-color focus:ring-2 focus:ring-highlight-color focus:bg-card-color-focus rounded-md shadow-md  shadow-slate-800
      transition-all duration-1000 ease-in-out flex-col group cursor-pointer hover:bg-card-color-hover hover:shadow-lg hover:shadow-slate-800  dark:focus:ring-offset-slate-500 focus:ring-offset-slate-400 focus:ring-offset-8" //focus:bg-sky-700 hover:bg-sky-800
      tabIndex={-2}
    >
